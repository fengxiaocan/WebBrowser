    ...
    public static class ThreadPoolProxy {
        ...
        private void initPool() {
            if (mPool == null || mPool.isShutdown()) {
                ...
                workQueue = new ArrayBlockingQueue<Runnable>(100);//FIFO,大小有限制
                ...
                //                handler = new ThreadPoolExecutor.AbortPolicy();//触发异常，提醒调用者
                handler = new ThreadPoolExecutor.DiscardPolicy();//不做任何处理
                //                handler = new ThreadPoolExecutor.CallerRunsPolicy();//直接当前线程执行，不归线程池控制,有可能是主线程
